document.addEventListener('DOMContentLoaded', function () { // 페이지가 로드되면 실행
    ...
    const partyColors = {
        ...
        '통합 트라야비야': 'rgb(65, 105, 225)',            // 로열 블루 (보수)
        ...
        '하파차의 후예': 'rgb(153, 50, 204)',      // 보라색 (하파차 지역)
        '도마니 연합': 'rgb(255, 165, 0)',         // 오렌지 (도마니 지역)
        '테트라 인민당': 'rgb(139, 69, 19)',       // 갈색 (테트라 지역)
        '세오어 보호당': 'rgb(255, 215, 0)',        // 금색 (그라나데, 포어 지역)
        '살기좋은 안텐시': 'rgb(144, 238, 144)',    // 라이트 그린 (안텐시 지역)
        '림덴시에 어서오세요': 'rgb(255, 77, 77)',  // 진한 분홍색 (림덴시 지역)
    };
