document.addEventListener('DOMContentLoaded', function () { // 페이지가 로드되면 실행
    ...
    const partyColors = {
        ...
        '그미즈리 노동당': 'rgb(70, 130, 180)', // 스틸 블루 (그미즈리 지역)
        '그미즈리 녹색당': 'rgb(0, 150, 136)', // 티얼 그린 (그미즈리 지역)
        '그미즈리 민주당': 'rgb(100, 149, 237)', // 콘플라워 블루 (그미즈리 지역)
        '그미즈리 보수당': 'rgb(30, 144, 255)', // 도저 블루 (그미즈리 지역)
        '그미즈리 사회당': 'rgb(135, 206, 250)', // 라이트 스카이 블루 (그미즈리 지역)
        '그미즈리 자유당': 'rgb(0, 40, 100)', // 다크 블루 (그미즈리 지역)
        '그미즈리 통합당': 'rgb(51, 204, 255)', // 라이트 블루 (그미즈리 지역)
        '그미즈리 혁신당': 'rgb(0, 255, 255)', // 시안 (그미즈리 지역)
